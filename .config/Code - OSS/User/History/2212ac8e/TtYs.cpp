...
int main() {
    ...
    cout << "the latency of bubble sorting function was: "<<latency<<" microseconds";
    {
        Timer timer;
        selectionsort(numbers); 
    }
    cout << "the latency of selection sorting function was: "<<latency<<" microseconds";
    {
        Timer timer;
        insertionsort(numbers);
    }
    cout << "the latency of insertion sorting function was: "<<latency<<" microseconds";
    {
        Timer timer;
        heapSort(numbers);
    
    }
    cout << "the latency of heap sorting function was: "<<latency<<" microseconds";
    {
        Timer timer;
        shellSort(numbers);
    
    }
    cout << "the latency of shell sorting function was: "<<latency<<" microseconds";
    {
        Timer timer;
        mergeSort(numbers, range);  
    }
    cout << "the latency of merge sorting function was: "<<latency<<" microseconds";
    {
        Timer timer;
        quickSort(numbers, 0, range - 1);      
    }
    cout << "the latency of quick sorting function was: "<<latency<<" microseconds";
    cout << "sorted array: [ ";
    print(numbers);
    cout <<"]"<<endl;
    return 0;
